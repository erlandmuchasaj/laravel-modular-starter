...
/**
 * Sanitize input to be used in search result
 *
 * @author E.M
 */
class Sanatize
{
     ...
     */
    const PREG_CLASS_PUNCTUATION = '\x{21}-\x{23}\x{25}-\x{2a}\x{2c}-\x{2f}\x{3a}\x{3b}\x{3f}\x{40}\x{5b}-\x{5d}'.
    ...
    const PREG_CLASS_NUMBERS = '\x{30}-\x{39}\x{b2}\x{b3}\x{b9}\x{bc}-\x{be}\x{660}-\x{669}\x{6f0}-\x{6f9}'.
